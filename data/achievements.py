...
ACHIEVEMENTS = [
    ...
    {"id": "game-master", "icon": "gamepad", "title": "Game Master",
     "desc": "Finish the Playful Python: Games & Puzzles course.",
     "check": lambda s: "python-games" in s["courses_done"]},
    {"id": "algorithm-ace", "icon": "search", "title": "Algorithm Ace",
     "desc": "Finish the Think Like a Programmer course.",
     "check": lambda s: "algorithms" in s["courses_done"]},
    {"id": "data-analyst", "icon": "chart", "title": "Data Analyst",
     "desc": "Finish the Data Analysis Essentials course.",
     "check": lambda s: "data-analysis" in s["courses_done"]},
    ...
    {"id": "arena-legend", "icon": "crown", "title": "Arena Legend",
     ...
     "check": lambda s: s["challenges_done"] >= s.get("total_challenges", 10)},
